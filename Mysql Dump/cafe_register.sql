...
CREATE TABLE `register` (
  `cust_id` varchar(3) CHARACTER SET utf8 NOT NULL,
  ...
  `pwd` varchar(15) CHARACTER SET utf8 NOT NULL,
  `phn` int(10) NOT NULL,
  `reward_pts` int(3) NOT NULL DEFAULT '0',
  PRIMARY KEY (`cust_id`),
...
-- Dump completed on 2016-03-29 23:27:21
